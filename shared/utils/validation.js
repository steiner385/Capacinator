...
exports.validateIntInRange = validateIntInRange;
exports.validateDateFormat = validateDateFormat;
exports.validateRequired = validateRequired;
exports.validateStringLength = validateStringLength;
exports.validateEmail = validateEmail;
exports.validateAllocationPercentage = validateAllocationPercentage;
 ...
 */
function validateIntInRange(value, min, max, defaultValue) {
    ...
    const wasValidNumber = value !== null &&
        value !== undefined &&
        originalStr !== '' &&
 ...
 */
function validateDateFormat(value, format = 'ISO_DATE') {
 ...
 */
function validateStringLength(value, minLength = 0, maxLength = Infinity, fieldName = 'Value') {
    const str = value ?? '';
 ...
 */
function validateAllocationPercentage(value) {
 ...
 */
function validatePriority(value, maxPriority = 5) {
