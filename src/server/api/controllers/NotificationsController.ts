...
export class NotificationsController {
  ...
  async sendNotification(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error sending notification', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async getUserNotificationPreferences(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error fetching notification preferences', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async getEmailTemplates(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error fetching email templates', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async getNotificationHistory(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error fetching notification history', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async sendTestEmail(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error sending test email', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async checkEmailConfiguration(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error checking email configuration', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async getNotificationStats(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error fetching notification stats', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async triggerAssignmentNotification(
    ...
    try {
      ...
      logger.error('Error triggering assignment notification', error instanceof Error ? error : undefined);
    }
  }
  ...
  async triggerApprovalNotification(
    ...
    try {
      ...
      logger.error('Error triggering approval notification', error instanceof Error ? error : undefined);
    }
  }
  ...
  async triggerProjectNotification(
    ...
    try {
      ...
      logger.error('Error triggering project notification', error instanceof Error ? error : undefined);
    }
  }
}