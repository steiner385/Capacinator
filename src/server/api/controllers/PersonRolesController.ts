...
export class PersonRolesController extends BaseController {
  ...
  async getPersonRoles(req: Request, res: Response) {
    try {
      ...
      logger.error('Error fetching person roles', error as Error, { personId });
  ...
  async addPersonRole(req: Request, res: Response) {
    try {
      ...
      logger.error('Error adding person role', error as Error, { personId });
  ...
  async updatePersonRole(req: Request, res: Response) {
    try {
      ...
      logger.error('Error updating person role', error as Error, { personId, roleId });
  ...
  async removePersonRole(req: Request, res: Response) {
    try {
      ...
      logger.error('Error removing person role', error as Error, { personId, roleId });
