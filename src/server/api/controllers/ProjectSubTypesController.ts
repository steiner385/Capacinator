...
export class ProjectSubTypesController {
  ...
  async getAll(req: Request, res: Response) {
    try {
      ...
      logger.error('Error fetching project sub-types', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      logger.error('Error fetching project sub-type', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async create(req: Request, res: Response) {
    try {
      ...
      logger.error('Error creating project sub-type', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      logger.error('Error updating project sub-type', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      logger.error('Error deleting project sub-type', error instanceof Error ? error : undefined);
      res.status(500).json({
        success: false,
  ...
  private async inheritFromProjectType(subTypeId: string, projectTypeId: string) {
    try {
      ...
      logger.error('Error inheriting from project type', error instanceof Error ? error : undefined);
      throw error;
    }
  }
}
