...
export class RecommendationsController {
  ...
  async getRecommendations(req: Request, res: Response) {
    try {
      ...
      logger.error('Error generating recommendations', error instanceof Error ? error : undefined);
  ...
  async executeRecommendation(req: Request, res: Response) {
    try {
      ...
      logger.error('Error executing recommendation', error instanceof Error ? error : undefined);
