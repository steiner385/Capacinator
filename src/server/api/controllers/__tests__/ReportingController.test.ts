...
describe('ReportingController', () => {
  ...
  describe('getDemandReport - Get Demand Report', () => {
    ...
    // Note: Tests for internal aggregation logic removed during controller-service refactoring
    // The aggregation, timeline generation, and scenario filtering logic is now in DemandCalculationService
    // and tested in DemandCalculationService.test.ts
