...
export async function up(knex: Knex): Promise<void> {
  ...
  // 1. Project demands view - combines standard allocations with overrides
  await knex.raw(`
  ...
  // 3. Person availability view (simplified for SQLite)
  await knex.raw(`
  ...
  // 5. Capacity gaps view (simplified)
  await knex.raw(`
