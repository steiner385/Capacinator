...
export async function up(knex: Knex): Promise<void> {
  console.log('Recreating views after project type refactoring...');
  ...
  // 3. Person availability view (same as before)
  await knex.raw(`
  ...
  // 4. Person utilization view (same as before)
  await knex.raw(`
  ...
  // 7. Supervisor permissions view (same as before)
  await knex.raw(`
  ...
  // 8. Role planner permissions view (same as before)
  await knex.raw(`
  ...
  console.log('✅ All views recreated successfully with updated schema');
}
