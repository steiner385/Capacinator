...
export async function up(knex: Knex): Promise<void> {
  console.log('Improving project_demands_view with hour calculations...');

  // Drop the existing view
  await knex.raw('DROP VIEW IF EXISTS project_demands_view');

  // Create the improved project_demands_view with hour calculations
  await knex.raw(`
  ...
  console.log('✅ Improved project_demands_view with hour calculations and project type info');
}

export async function down(knex: Knex): Promise<void> {
  console.log('Reverting project_demands_view improvement...');
  
  // Drop the improved view
  await knex.raw('DROP VIEW IF EXISTS project_demands_view');
