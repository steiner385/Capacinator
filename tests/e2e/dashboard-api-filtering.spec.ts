...
test.describe('Dashboard API Current Projects Filtering', () => {
  ...
  test('should filter projects by current date in API', async ({ request }) => {
    // Direct API test to verify filtering logic
    const response = await request.get('/api/reporting/dashboard');
  ...
  test('should return consistent data across multiple API calls', async ({ request }) => {
    // Make multiple API calls to ensure consistency
    const responses = await Promise.all([
      request.get('/api/reporting/dashboard'),
      request.get('/api/reporting/dashboard'),
      request.get('/api/reporting/dashboard')
    ]);
  ...
  test('should filter project health for current projects only', async ({ request }) => {
    const response = await request.get('/api/reporting/dashboard');
    const data = await response.json();
  ...
  test('should calculate capacity gaps for current projects only', async ({ request }) => {
    const response = await request.get('/api/reporting/dashboard');
    const data = await response.json();
  ...
  test('should show availability relative to current project assignments', async ({ request }) => {
    const response = await request.get('/api/reporting/dashboard');
    const data = await response.json();
  ...
  test('should validate utilization data for current projects', async ({ request }) => {
    const response = await request.get('/api/reporting/dashboard');
    const data = await response.json();
  ...
  test('should handle edge case of no current projects', async ({ request }) => {
  ...
  test('should validate date-based filtering logic', async ({ request }) => {
